...
require_once __DIR__ . "/BackupScheduleTest.php";
require_once __DIR__ . "/SensitiveParameterTest.php";
require_once __DIR__ . "/DatabaseCreateTest.php";
require_once __DIR__ . "/DatabaseDeleteTest.php";
require_once __DIR__ . "/SameUserAuthorizerTest.php";

use Hestiacp\Adapter\Test\AuthorizationTest;
use Hestiacp\Adapter\Test\BackupScheduleTest;
...
use Hestiacp\Adapter\Test\SensitiveParameterTest;
use Hestiacp\Adapter\Test\DatabaseCreateTest;
use Hestiacp\Adapter\Test\DatabaseDeleteTest;
use Hestiacp\Adapter\Test\SameUserAuthorizerTest;
...
BackupScheduleTest::register($t);
SensitiveParameterTest::register($t);
DatabaseCreateTest::register($t);
DatabaseDeleteTest::register($t);
SameUserAuthorizerTest::register($t);
exit($t->run());
