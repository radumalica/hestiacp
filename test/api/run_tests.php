...
require_once __DIR__ . "/SpyAuditLogger.php";
require_once __DIR__ . "/AuditLoggerTest.php";
require_once __DIR__ . "/AuditProvisioningTest.php";
require_once __DIR__ . "/GenericityTest.php";

use Hestiacp\Adapter\Test\MiniTest;
use Hestiacp\Api\Test\AuditLoggerTest;
use Hestiacp\Api\Test\AuditProvisioningTest;
...
AuditLoggerTest::register($t);
AuditProvisioningTest::register($t);
